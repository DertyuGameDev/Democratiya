...
response = get('http://127.0.0.1:8080/api/users/1')
print('Status code:', response.status_code)
print('Raw response:', repr(response.text))

#сначала запустить сервак, потом тесты
print('1:', get('http://127.0.0.1:8080/api/users').json())  # получение всех юзеров
print('2:', get('http://127.0.0.1:8080/api/users/1').json())  # получение одного юзера
