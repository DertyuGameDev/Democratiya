...
print("1:", get('http://127.0.0.1:8080/api/jobs').json())  # все работы
print("2:", get('http://127.0.0.1:8080/jobs/2').json())  # одна работа
print("3:", post("http://127.0.0.1:8080/api/jobs",
                 json={"team_leader": 1, "job": "test_post", "work_size": 1, "collaborators": "2",
                       "is_finished": True}))  # создание работы
print("4:", put("http://127.0.0.1:8080/api/edit_jobs/1",
